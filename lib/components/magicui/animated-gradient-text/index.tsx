...
export default function AnimatedGradientText({
  ...
  return (
    ...
    >
      <div
        className={`animate-gradient absolute inset-0 block h-full w-full [border-radius:inherit] bg-linear-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 bg-[length:var(--bg-size)_100%] p-[1px] [mask-composite:subtract]! [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)]`}
      />
