...
export default function AnimatedCircularProgressBar({ max = 100, min = 0, value = 0, gaugePrimaryColor, gaugeSecondaryColor, className }: Props) {
  ...
  return (
    <div
      className={clsx("relative size-40 text-2xl font-semibold", className)}
      style={
        {
          "--circle-size": "100px",
