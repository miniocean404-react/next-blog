  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        <div
          className="no-scrollbar flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth py-10 md:py-20"
          ref={carouselRef}
          onScroll={checkScrollability}
        >
          <div
            className={clsx("absolute right-0 z-1000 h-auto w-[5%] overflow-hidden bg-linear-to-l")}
          ></div>
...
export const BlurImage = ({ height, width, src, className, alt, ...rest }: ImageProps) => {
  ...
  return (
    <Image
      className={clsx("transition duration-300", isLoading ? "blur-xs" : "blur-0", className)}
