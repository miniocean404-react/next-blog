      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative flex h-44 w-44 items-center justify-center rounded-full text-4xl font-bold text-white">
            <div className="absolute h-full w-full rounded-full bg-white/80 blur-xs dark:bg-black/80" />
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        ...
        style={style}
      >
        <p className="absolute inset-x-0 h-full font-mono text-xs font-bold wrap-break-word whitespace-pre-wrap text-white transition duration-500">
          {randomString}
        </p>
      </motion.div>
    </div>
