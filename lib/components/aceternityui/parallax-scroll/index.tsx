...
export const ParallaxScroll = ({ images, className }: { images: string[]; className?: string }) => {
  ...
  return (
    <div className={clsx("h-160 w-full items-start overflow-y-auto", className)} ref={gridRef}>
      <div
        ...
        <div className="grid gap-10">
          {firstPart.map((el, idx) => (
            ...
            >
              <Image
                src={el}
                className="m-0! h-80 w-full gap-10 rounded-lg object-cover object-top-left p-0!"
                height="400"
                width="400"
                alt="thumbnail"
              />
